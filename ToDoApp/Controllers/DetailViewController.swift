...
final class DetailViewController: UIViewController {
    ...
    func setup() {
        ...
        backgrounView.clipsToBounds = true
    ...
    func configureUI() {
        ...
        if let toDoData = self.toDoData {
            ...
            //becomeFirstResponder(): 이 개체를 해당 창의 첫 번째 응답자로 만들도록 UIKit에 요청
    ...
    func setupColorTheme(color: MyColor? = .red) {
        backgrounView.backgroundColor = color?.backgoundColor
...
extension DetailViewController: UITextViewDelegate {
    ...
    // 비어있으면 다시 플레이스 홀저처럼 입력하기 위해서 조건 확인
